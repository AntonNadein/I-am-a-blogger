...
class UserCreateViewTests(TestCase):
    ...
    def setUp(self):
        ...
        self.user_client = self.client.post(
            self.url,
            {
                "username": "testuser",
                "email": "test@test.ru",
...
class ModerationUsersViewTests(TestCase):
    def setUp(self):
        ...
        self.test_user = User.objects.create(
            username="test_user_2", password="password", email="test2@test.ru", is_active=True
        )
    ...
    def test_user_list_view_with_permissions_and_cache(self):
        ...
        self.assertCountEqual(cached_usernames, ["admin", "testuser", "test_user_2"])
...
class LoginUsersViewTests(TestCase):
    ...
    def setUp(self):
        ...
        self.test_user = User.objects.create(
            username="test_user", password="password", email="test@test.ru", is_active=True
        )
...
class UserDetailViewTests(TestCase):
    ...
    def setUp(self):
        ...
        self.other_user = User.objects.create_user(
            username="other_user", password="otherpassword", email="test1@test.ru"
        )
