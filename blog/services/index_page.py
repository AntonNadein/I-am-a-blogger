...
class ServiceIndex:
        ...
        return [
            {
                ...
                "count": self.blog_objects.filter(
                    created_at__year=archive.year, created_at__month=archive.month
                ).count(),
            }
    ...
    def get_queryset_archive(self, page_link):
        ...
        if page_link is None:
            ...
            return self.queryset_page.filter(
                created_at__year=list_month_year[1], created_at__month=number_month, is_published=True
            )
